            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                ...
                                                <?php 
                                                    $param_user_id = $_GET["id"];

                                                    $sql = "SELECT COUNT(visit_id) AS visitsAmount FROM visits WHERE user_id = $param_user_id";
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $sql = "SELECT visit_id, user_id, ticketCode, visitDate, CASE WHEN visitStatus = 1 THEN 'Canjeado' ELSE 'No canjeado' END AS visitEstatustxt FROM visits WHERE user_id = $param_user_id";
                                                    ...
                                                    while($mostrar=mysqli_fetch_array($result))
                                                    {
                                                        ?> 
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><?php echo $mostrar ['visitEstatustxt'] ?></td>
                                                                <td class="text-center">
                                                                    <a href="removeVisit.php?id=<?php echo $mostrar ['visit_id'] ?>" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="administrator.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
